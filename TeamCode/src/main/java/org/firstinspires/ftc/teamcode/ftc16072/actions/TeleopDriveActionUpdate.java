...
public class TeleopDriveActionUpdate extends QQ_Action {
    double pivotAngle = 0;
    boolean wasUp;
    boolean wasDown;
    ...
    void manipulatorControls(QQ_Opmode opmode) {
        ...
        if (opmode.qq_gamepad2.b() || opmode.qq_gamepad2.rightTrigger() > 0.1) {
        ...
        if (opmode.qq_gamepad2.leftBumper() || opmode.qq_gamepad2.rightStick.getY() > 0.2){
